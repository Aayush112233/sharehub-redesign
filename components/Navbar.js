      ...
      >
        <div className="flex h-[58px] w-full items-center justify-between px-4">
          ...
          <div className="flex items-center gap-x-1">
            <button
              className="hidden px-4 py-2 font-sans text-xs font-bold text-center text-gray-900 uppercase align-middle transition-all rounded-lg select-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none md:inline-block"
              type="button"
            >
