...
const RightShares = () => {
  ...
  return (
    <>
    <div class="flex h-fit w-full border-[3px] border-white dark:border-slate-900 md:flex-row flex-col  md:items-center items-start justify-between rounded-t-2xl bg-white dark:bg-slate-900 px-4 pt-4 shadow-2xl shadow-gray-100  dark:shadow-none">
      ...
      <div class="relative overflow-x-auto border-[3px] rounded-b-lg border-white dark:border-slate-900">
        <table class="w-full text-sm text-left min-h-[500px] rtl:text-right text-gray-500 dark:text-gray-400">
